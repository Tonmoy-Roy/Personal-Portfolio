                ...
                <div className='md:grid grid-cols-3 gap-8'>
                    <div className="border border-gray-600 rounded-xl overflow-hidden group shadow-md hover:shadow-xl mb-5">
                        ...
                        <div className="card-body">
                            <h2 className="card-title justify-center font-bold text-xl mb-3 text-gray-200">
                                Jewellery Shopping
                            </h2>
                            <div className="card-actions justify-center gap-5">
                                <Link to="https://jewellery-shopping-fn4z.vercel.app/">
                                    <button className="btn btn-neutral glow-on-hover text-gray-200">
                                        Live Demo
                                    </button>
                                </Link>
                                <Link to="https://github.com/Tonmoy-Roy/Jewellery-Shopping">
                                    <button className="btn btn-neutral hover:bg-black transition duration-300 text-gray-200">
                                        GitHub
                                    </button>
                                </Link>
                            </div>
                    ...
                    <div className="border border-gray-600 rounded-xl overflow-hidden group shadow-md hover:shadow-xl mb-5">
                        ...
                        <div className="card-body">
                            <h2 className="card-title text-gray-200 font-bold text-xl mb-3 md:w-[17vw] text-center">Food Ordering System</h2>
                            <div className="card-actions justify-evenly">
                                <Link to="https://restaurant-management-70a73.web.app/"><button className="btn btn-neutral glow-on-hover text-gray-200">Live Demo</button></Link>
                                <Link to="https://github.com/Tonmoy-Roy/Restaurant-Management-System-cs"><button className='btn btn-neutral hover:bg-black transition duration-300 text-gray-200'>Github</button></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border border-gray-600 rounded-xl overflow-hidden group shadow-md hover:shadow-xl mb-5">
                        ...
                        <div className="card-body">
                            <h2 className="card-title text-gray-200 justify-center font-bold text-xl mb-3">Movie Watchlist</h2>
                            <div className="card-actions justify-evenly">
                                <Link to="https://movie-verse-76e61.web.app/"><button className="btn btn-neutral glow-on-hover text-gray-200">Live Demo</button></Link>
                                <Link to="https://github.com/Tonmoy-Roy/Movie-Verse-cs"><button className='btn btn-neutral hover:bg-black transition duration-300 text-gray-200'>Github</button></Link>
                            </div>
                        </div>
                    </div>
